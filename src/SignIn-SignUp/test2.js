...
export default function CreateNewCategoryModal(props) {
  ...
  const [selectedButton, setSelectedButton] = useState(null); // To track the selected button
          ...
          <Box sx={style}>
            ...
            <Box sx={{ my: 2 }}>
              <Button
                ...
                sx={{
                  backgroundColor: selectedButton === 'button1' ? "rgba(167,215,249,255)" : "rgba(167,215,249,0.5)",
                }}
              ...
              <Button
                ...
                style={emptyRoundButtonStyle}
                sx={{
                  backgroundColor: selectedButton === 'button2' ? "rgba(207,217,250,255)" : "rgba(207,217,250,0.5)",
                }}
              ...
              <Button
                ...
                style={emptyRoundButtonStyle}
                sx={{
                  backgroundColor: selectedButton === 'button3' ? "rgb(244,187,199,255)" : "rgb(244,187,199,0.5)",
                }}
              ...
              <Button
                ...
                style={emptyRoundButtonStyle}
                sx={{
                  backgroundColor: selectedButton === 'button4' ? "rgba(192,248,137,255)" : "rgba(192,248,137,0.5)",
                }}
